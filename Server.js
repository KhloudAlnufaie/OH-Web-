...
app.get('/myinfo', async function(req, res) {
	...
	try{
		...
		let studentInfo = [student.user.Fname, student.user.Sname, student.user.Tname, student.user.Lname, student.user.email, student.password];
		
		res.render('myinfo', {studentInfo} );
...
app.get('/index', async function(req, res) {
	...
	const teacher = await TeacherSchema.find({}).then( async function(teacher_info){
		...
		res.render('index', {teachers_list: teachers_list, count, exist});
